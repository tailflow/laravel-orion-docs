...
::warning
If you are using Sanctum, CSRF protection needs to be initialized, before you can query the API. Learn how to accomplish that in the [Sanctum integration guide](/typescript-sdk/configuration#integration-with-sanctum-for-spa).
::

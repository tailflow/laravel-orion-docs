...
seo:
  title: Responses (1.x)
  description: Learn how models are transformed into JSON responses in Orion 1.x. This is the legacy version.
---
...
For example, if you have an `App\Models\Message` model, the related resource class would be `App\Http\Resources\MessageResource` or `App\Http\Resources\MessageCollectionResource`.

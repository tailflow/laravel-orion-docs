---
title: Configuration
description: Learn how to set the API URL, configure authentication, and configure the underlying HTTP client.
seo:
  title: Configuration (TypeScript SDK 1.x)
  description: Learn how to set the API URL and configure authentication in Orion TypeScript SDK 1.x. This is the legacy version.
---
